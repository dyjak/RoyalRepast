                ...
                <div class="col-md-6">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-center">
                            <div>
                                <img src="{{ asset('storage/logo/' . $meal->restaurant->logo_path . '.png') }}" alt="Restaurant Logo"
                        ...
                        @foreach($sampleMeals as $meal_i)
                            <div class="col-md-3 mb-3">
                                <div class="card h-100">
                                    <div class="clickable-card" onclick="window.location.href='{{ route('meal.details', ['meal' => $meal_i->id]) }}'">
