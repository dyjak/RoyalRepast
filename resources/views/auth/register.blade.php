<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="postal_code" class="block mt-1 w-full" type="text" name="postal_code" :value="old('postal_code')" required autocomplete="postal_code" pattern="[0-9]{2}-[0-9]{3}" title="Format: XX-XXX"/>
        ...
        <div class="mt-4">
            ...
            <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="old('phone')" required autocomplete="phone" pattern="\+\d{2} \d{3} \d{3} \d{3}" title="Format: +XX YYY ZZZ ZZZ" />
